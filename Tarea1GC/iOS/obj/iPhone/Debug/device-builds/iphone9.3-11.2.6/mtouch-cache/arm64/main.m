...
extern void *mono_aot_module_Tarea1GC_iOS_info;
...
extern void *mono_aot_module_Tarea1GC_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_Tarea1GC_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Tarea1GC_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Tarea1GC.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
